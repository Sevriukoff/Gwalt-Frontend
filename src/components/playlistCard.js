      ...
      <div className='flex flex-col w-full group'>
        <div className='relative w-full pb-[100%] overflow-hidden rounded-[4px]'>
          <Image
              ...
              layout='fill'
              objectFit='cover'
              className='rounded-[4px] group-hover:scale-110 transform transition duration-300'
          />
          ...
          <div className='absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition duration-300'>
            <button>
              <img src='/purple-play.svg' alt='Play Icon' className='w-12 h-12 opacity-80 hover:opacity-100'/>
            </button>
          </div>
        </div>
        <div className='mt-1.5 flex flex-col flex-grow'>
          <a className='text-base text-black font-normal'>{`Techo #`}</a>
