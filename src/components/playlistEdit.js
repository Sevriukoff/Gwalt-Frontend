...
const PlaylistEdit = ({ selectedFiles }) => {
  ...
  const fetchGenres = async () => {
    try {
      const response = await fetch('http://localhost:5135/api/v1/genres');
      ...
      <div className="max-w-4xl mx-auto p-6">
        <div className="grid grid-cols-[auto_1fr] gap-5 mb-4">
          ...
          <div className="col-span-1">
            ...
            <div className="mb-4">
              <label className="block text-gray-700">Playlist type</label>
        ...
        <div className="flex justify-end">
          <button className="bg-gray-300 text-gray-700 px-4 py-2 rounded mr-2" onClick={handleFileUpload}>Cancel</button>
